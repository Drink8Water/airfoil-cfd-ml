...
docs/
  ...
  GEOMETRY_ENCODING.md      # geometry encoding schemes (Planned)
  LIMITATIONS.md            # known limitations and future work
  MODEL_ZOO.md              # model architecture catalog
  PHYSICS_LOSSES.md         # physics-aware loss functions
  PROJECT_STRUCTURE.md      # this file
  RELEASE_CHECKLIST.md      # release checklist
  REPRODUCIBILITY.md        # Windows/PowerShell reproducibility guide
  REPRODUCIBILITY_LINUX.md  # Linux/bash reproducibility guide
  RESEARCH_QUESTIONS.md     # five core research questions
  RESULTS.md                # results, leaderboard, and ablations
  TRAINING_ACCELERATION.md  # training acceleration strategies
```
